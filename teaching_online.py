...
if __name__ == "__main__":
    ...
    M_0 = (n_states, n_actions, R, P)
    env = environment.Environment(M_0)

    target_pi = np.ones(env.n_states, dtype="int")

    for iter_num in range(0, number_of_iterations):
        ################# NON Target Reward ########################
        teaching_obj_nontarget_reward = teaching(env, target_pi=target_pi, epsilon=0.1, p=np.inf, epsilon_p=0.0001, T_UCRL=1e+5, alpha_UCRL=0.5, attackers_cost_p=1, teacher_type="non_target_attack_on_reward")
        ...
        teaching_obj_general_reward = teaching(env, target_pi=target_pi, epsilon=0.1, p=np.inf, epsilon_p=0.0001, T_UCRL=1e+5, alpha_UCRL=0.5, attackers_cost_p=1, teacher_type="general_attack_on_reward")
        ...
        ################## General Reward p=1 #########################
        teaching_obj_general_reward = teaching(env, target_pi=target_pi, epsilon=0.1, p=1, epsilon_p=0.0001, T_UCRL=1e+5, alpha_UCRL=0.5, attackers_cost_p=1, teacher_type="general_attack_on_reward")
        teaching_obj_general_reward.end_to_end_teaching()
        ...
        teaching_obj_general_reward = teaching(env, target_pi=target_pi, epsilon=0.1, p=np.inf, epsilon_p=0.0001, T_UCRL=1e+5, alpha_UCRL=0.5, attackers_cost_p=1, teacher_type="general_attack_on_dynamics")
        teaching_obj_general_reward.end_to_end_teaching()
        accumulator_dict = accumulator_function(teaching_obj_general_reward.learner, accumulator_dict, teaching_obj_general_reward.teacher_type, p="inf")

        ################## General dynamics p=1 #########################
        teaching_obj_general_reward = teaching(env, target_pi=target_pi, epsilon=0.1, p=1, epsilon_p=0.0001, T_UCRL=1e+5, alpha_UCRL=0.5, attackers_cost_p=1, teacher_type="general_attack_on_dynamics")
        teaching_obj_general_reward.end_to_end_teaching()
        accumulator_dict = accumulator_function(teaching_obj_general_reward.learner, accumulator_dict, teaching_obj_general_reward.teacher_type, p=1)

        ################## Non Target Dynamics #########################
        teaching_obj_general_reward = teaching(env, target_pi=target_pi, epsilon=0.1, p=np.inf, epsilon_p=0.0001, T_UCRL=1e+5, alpha_UCRL=0.5, attackers_cost_p=1, teacher_type="non_target_attack_on_dynamics")
        teaching_obj_general_reward.end_to_end_teaching()
        accumulator_dict = accumulator_function(teaching_obj_general_reward.learner, accumulator_dict, teaching_obj_general_reward.teacher_type, p="inf")

    ################## Calculate average #######################
    accumulator_dict = calculate_average(accumulator_dict, number_of_iterations)
    plot_chain.plot_online_teaching(dict_to_plot=accumulator_dict, plot_every_after_n_points=5000, show_plots=False)
